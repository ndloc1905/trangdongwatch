<?php /* Smarty version 2.6.20, created on 2011-07-24 16:40:11
         compiled from cate/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'select_status', 'cate/index.tpl', 7, false),array('function', 'select_cateparent', 'cate/index.tpl', 8, false),array('function', 'apaging', 'cate/index.tpl', 36, false),array('modifier', 'status', 'cate/index.tpl', 27, false),array('modifier', 'number_format', 'cate/index.tpl', 33, false),)), $this); ?>
...
<form onsubmit="return false;" id="form1" name="form1" method="POST" action="<?php echo @HOST_CATE; ?>
/doaction">
<div class="padT2">
...
')"/>
	...
	<?php echo smarty_function_select_cateparent(array('item0' => $this->_tpl_vars['t']->_('all'),'filter' => '1','selected' => $this->_tpl_vars['intParentId'],'attribs' => 'onchange="subcate(this.value);" style="float:left;margin-right:2px;"'), $this);?>
...
<table width="100%" cellpadding="0" cellspacing="0" border="1">
	<tr>
		...
		<th width="300px">Forum</th>			
		<th><?php echo $this->_tpl_vars['t']->_('parent_name'); ?>
</th>			
		<th width="120px"><?php echo $this->_tpl_vars['t']->_('zorder'); ?>
</th>
...
?>
	<tr>
		<td><input type="checkbox" name="items[]" value="<?php echo $this->_tpl_vars['row']['cateid']; ?>
" /></td>
		<td><?php echo $this->_tpl_vars['row']['name']; ?>
</td>			
		<td><?php echo $this->_tpl_vars['row']['parent_name']; ?>
</td>
		...
		<td align="center"><a href="<?php echo @HOST_CATE; ?>
/update?id=<?php echo $this->_tpl_vars['row']['cateid']; ?>
...
" onclick="document.location.href='<?php echo @HOST_CATE; ?>
