<?php /* Smarty version 2.6.20, created on 2011-07-24 17:51:52
         compiled from comment/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'status', 'comment/index.tpl', 35, false),array('modifier', 'date_format', 'comment/index.tpl', 36, false),array('modifier', 'number_format', 'comment/index.tpl', 42, false),array('function', 'apaging', 'comment/index.tpl', 44, false),)), $this); ?>
...
<div class="navMain">
	...
	<form onsubmit="return false;" id="form1" name="form1" method="POST" action="<?php echo @HOST_COMMENT; ?>
/doaction">
	<div class="padT2">	
...
')"/>
		<select id="pstatus" name="pstatus" style="float:left;margin-right:2px;">
			<option value="0"><strong><?php echo $this->_tpl_vars['t']->_('all'); ?>
</strong></div>			
			<option value="1"<?php if ($this->_tpl_vars['intStatus'] == 1): ?> selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['t']->_('active'); ?>
</div>
			<option value="2"<?php if ($this->_tpl_vars['intStatus'] == 2): ?> selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['t']->_('inactive'); ?>
</div>			
			<option value="3"<?php if ($this->_tpl_vars['intStatus'] == 3): ?> selected="selected"<?php endif; ?>>Đặt gạch</div>				
		</select>
...
" /></td>
			...
			<td>
				<?php echo $this->_tpl_vars['t']->_('topic'); ?>
:<strong class="blue"> <?php echo $this->_tpl_vars['row']['title']; ?>
</strong> <br/>
				<?php echo $this->_tpl_vars['row']['content']; ?>

			</td>
			<td align="center"><?php if ($this->_tpl_vars['row']['type'] == 2): ?>Yes<?php else: ?>No<?php endif; ?></td>
